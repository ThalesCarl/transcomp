...
finiteVolumeDataEQ = np.loadtxt('../results/second_exercise/center_center/division_not_respected_equivalent_resistance_VC.csv',dtype=float,delimiter=',',skiprows=1)
finiteVolumeDataLI = np.loadtxt('../results/second_exercise/center_center/division_not_linear_interpolation_VC.csv',dtype=float,delimiter=',',skiprows=1)
analyticalSolutionData = np.loadtxt('../results/second_exercise/center_center/division_not_respected_AN.csv',dtype=float,delimiter=',',skiprows=1)
